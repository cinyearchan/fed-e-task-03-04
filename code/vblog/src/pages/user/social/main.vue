<template>
  <Layout :activeMenu="activeMenu">
    <div>
      <el-card
        shadow="never"
        style="min-height: 400px; margin-bottom: 20px; padding: 0 0 20px 0"
      >
...
export default {
  ...
  computed: {
    ...
    // ])
    githubUsername() {
      return store.getters.githubUsername
    },
    followersTotal() {
      return store.getters.followersTotal
    },
    followingTotal() {
      return store.getters.followingTotal
    }
  },
  mounted() {
