  ...
  <Layout :activeMenu="activeMenu">
    <div v-loading="loading">
      <el-card shadow="never" style="min-height:400px;margin-bottom:20px;">
        ...
        <el-row>
          <el-col :span="9" style="padding:0 10px 20px 0;">
            <img :src="avatarUrl" style="width:100%;border-radius:5px;">
            <div style="padding:10px;">
              <span style="font-size:26px;line-height:40px;font-weight:600;">{{ name }}<br></span>
              <span style="font-size:20px;font-style:normal;font-weight:300;line-height:35px;color:#666;">{{ githubUsername }}<br></span>
          ...
          <el-col :span="15" style="padding:0 20px 20px 10px;">
            ...
            <div style="width:100%;min-height:300px;border-radius:5px;border:1px solid #ebeef5;padding:30px;text-align:center;font-size:30px;color:#ddd;" v-else>
              <b>◔ ‸◔？没有简介</b>
            </div>
          </el-col>
        </el-row>
